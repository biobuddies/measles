...
Each directory snapshots an unformatted template, its formatted template, the rendered output,
and its formatted rendering. The Airflow and Django Admin examples are adapted from upstream:
